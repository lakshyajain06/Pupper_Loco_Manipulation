...
class LegPoseNeuralController : public controller_interface::ControllerInterface {
 public:
  LegPoseNeuralController();

  ~LegPoseNeuralController() = default;
 ...
 protected:
  ...
  static constexpr int kJointPositionIdx = 13;
  ...
  static constexpr int kSingleObservationSize = 3              /* base link angular velocity */
                                                ...
                                                + 4            /* x, y, z pose and leg_idx commands */
  ...
  realtime_tools::RealtimeBuffer<std::shared_ptr<std_msgs::msg::Float32MultiArray>> rt_manip_cmd_ptr_;
  rclcpp::Subscription<std_msgs::msg::Float32MultiArray>::SharedPtr manip_cmd_subscriber_ = nullptr;
